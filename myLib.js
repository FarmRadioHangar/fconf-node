...
function mailSend(mailConfig, subject, body, addressTo) {
...
function consoleLog(tags, level, label, message, values) {
	// temp: make compatible with jsonLog
